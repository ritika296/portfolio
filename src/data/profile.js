export const profile = {
  name: 'Ritika Prakash',
  role: 'Data & Business Analytics | Business Analyst',
  ...
  aboutBody: [
    ...
    "That problem-solving mindset is now channelled into analytics — working with Python, SQL, PostgreSQL, Power BI and Tableau to clean, model and visualize financial, customer and investment data, and to turn it into insights a business can act on.",
  ],
...
export const workingWith = [
  {
    label: 'Analytics',
    detail: 'Python \u2022 SQL \u2022 Power BI \u2022 Tableau',
  },
  {
    label: 'Data',
    detail: 'ETL \u2022 Data Cleaning \u2022 Data Modeling \u2022 PostgreSQL',
  },
  {
    label: 'Business',
    detail: 'Business Analytics \u2022 Problem Solving \u2022 Data Storytelling',
  },
  {
    label: 'Technology',
    detail: 'Git \u2022 GitHub \u2022 REST APIs \u2022 Databases',
  },
];
